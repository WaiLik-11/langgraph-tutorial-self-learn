...
# Sequence - Automatically handle the state updates for sequences such as by adding new messages to chat history 

# BaseMessage - foundational class for all message types in LangGraph 
# (BaseMessage -> Parent Class while the AIMessage, HumanMessages -> Child Classes -> Inherit all the properties of BaseMessage)

# Reducer Function - add_messages -> allow to append everything into the state without overwriting
